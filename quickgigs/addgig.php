    ...
    <!-- <div class="breadcrumb-bg breadcrumb-bg-about py-sm-5 py-4">
        ...
        <div class="w3l-about-us best-rooms py-5">
            <div class="container py-lg-5 py-sm-4">
                <h3 class="title-big text-center mb-md-5 mb-4">Your Project Details</h3>
                ...
                <form action="function.php" method="post" enctype="multipart/form-data" style="padding-left: 170px;">
                    <div class="row mt-5">
                        <div class="maghny-gd-1 col-lg-10 col-md-6">
                            <br><label><strong>Your Full Name</strong></label>
                           <!--  <input type="hidden" value="<?php echo $_SESSION['username'] ?>" name=""> -->
                           ...
                           <!--  <input type="number" class="form-control mb-3"  name="mobile" placeholder="Enter Your Phone Number">
                            ...
                            <textarea name="gname" id="gname" class="form-control mb-3" cols="50" rows="3"></textarea>
                            ...
                            <input type="submit" name="submitbutton" value="Submit Project" class="btn btn-primary mt-4">
                        </div>
