<?php
 ...
 if(isset($_GET['eid'])) {
      ...
      $sql="select * from signup where uid=$eid";
                ...
                <form action="function.php" method="POST" enctype="multipart/form-data" style="padding-left: 170px;">
                    <div class="row mt-5">
                        <div class="maghny-gd-1 col-lg-10 col-md-6">
                            ...
                            <input type="hidden" value="<?php echo $re->uid; ?>" name="userpid"/>
                           ...
                           -->
                            ...
                            <br><label><strong>Change Your Name</strong></label>
                           <!--  <textarea name="fname" id="fname" class="form-control mb-3" placeholder="First Name" cols="30" rows="1"><?php echo $re->fname; ?></textarea>
                            <textarea name="lname" id="lname" class="form-control mb-3" placeholder="Last Name" cols="30" rows="1"><?php echo $re->lname; ?></textarea> -->
                            <input type="text" class="form-control mb-3" name="fname" placeholder="Enter Your First Name" value="<?php echo $re->fname; ?>">
                            <input type="text" class="form-control mb-3"  name="lname" placeholder="Enter Your Last Name" value="<?php echo $re->lname; ?>">

                                <br><label><strong>Change Your Mobile Number</strong></label>
                                <input type="number" class="form-control mb-3"  name="mobile" placeholder="Enter Your Phone Number" value="<?php echo $re->mobile; ?>">

                                <br><label><strong>Change Your Email</strong></label>
                               <input type="email" class="form-control mb-3" name="email" placeholder="Enter Your Email" value="<?php echo $re->email; ?>"> 
                            ...
                            <input type="submit" name="updatepbutton" value="Update Now" class="btn btn-primary mt-4">
                        </div>
