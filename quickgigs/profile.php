    ...
    <!-- <div class="breadcrumb-bg breadcrumb-bg-about py-sm-5 py-4">
        ...
        <div class="w3l-about-us best-rooms py-5">
            <div class="container py-lg-5 py-sm-4">
                <h3 class="title-big text-center mb-md-5 mb-4">Profile Edit</h3>
                    ...
                    <div class="row mt-5">
                        <div class="maghny-gd-1 col-lg-50 col-md-12">
                            <table class="table">
                                ...
                                $sql="select * from signup where uid='$id'";
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $we->fname; ?></td>
                                    <td><?php echo $we->lname; ?></td>
                                    <td><?php echo $we->mobile; ?></td>
                                    <td><?php echo $we->email; ?></td>
                                    <!-- <td><?php echo $we->state; ?></td>
                                    <td><?php echo $we->city_name; ?></td>
                                    <td><?php echo $we->localname; ?></td> -->
                                    <td>
                                        <a href="editp.php?eid=<?php echo $we->uid; ?>" class="btn btn-info mb-1">EDIT</a>
